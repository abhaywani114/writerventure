...
$mail_array = array("abhay"=>"ajuwani@gmail.com","Support"=>"support@writerventure.com");
if (!isset($_GET['x'])) {
    exit;
}
...
$body = <<< EOD
Greetings $name,
We are delighted to invite you to publish your writings at our website <a href='http://writerventure.com'>Writer Venture</a>. We will be happy to have you. It is always free and in support of Freedom of Speach and Expression. We have some intresting like <strong>Follow up and Messaging</strong>. We hope you will enjoy and endure with writer venture.
...
With regards,
Abrar Ajaz Wani
Founder Writer Venture.
EOD;
   echo "sending email to $name at $email<br/>";
  
   $admin->mail2("Invitation from Writer Venture kashmir", $body, $email, $name,"support@writerventure.com","Support");
